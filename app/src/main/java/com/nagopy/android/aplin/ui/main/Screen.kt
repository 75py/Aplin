...
sealed class Screen(val route: String, @StringRes val resourceId: Int) {
    ...
    object UserAppList : Screen("userAppList", R.string.category_users), AppList {
        override fun getAppList(packagesModel: PackagesModel) = packagesModel.userPackages
    }

    object DisableableAppList : Screen("disableableAppList", R.string.category_disableable), AppList {
        override fun getAppList(packagesModel: PackagesModel) = packagesModel.disableablePackages
    }

    object AllAppList : Screen("allAppList", R.string.category_all), AppList {
        override fun getAppList(packagesModel: PackagesModel) = packagesModel.allPackages
    }

    interface AppList {
        fun getAppList(packagesModel: PackagesModel): List<PackageModel>
    }
